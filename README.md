<h2 align="center"><em>ShoppingMall Mini-game Clone Coding 📌</em></h2>
...
<p align="center"><em><a href="hello">Let's start!</a></em><br/>
<br/><em>
...
```
- data.json 데이터의 items를 동적으로 받아오기 위하여, 브라우저 API중 하나인 fetch()를 사용하는 방법을 학습했습니다.
